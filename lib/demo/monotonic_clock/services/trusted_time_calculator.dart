...
///     → Server Validation
///
/// This demo does not redesign the backend. If the API later exposes a
/// trusted server timestamp at login, store that as [TimeAnchor.wallClockLocal]
...
class TrustedTimeCalculator {
  ...
  TrustedTimeSnapshot calculate({
    ...
    final comparisonDelta = actualEventTime.difference(calculatedActualTime).abs();
