...
//     /// 🔥 BASE COLOR
//     final Color baseColor = backgroundColor ?? kSecondaryButtonColor;

//     /// 🔥 DISABLED COLOR (60% opacity)
//     final Color finalBgColor =
//         isactive ? baseColor : baseColor.withOpacity(0.6);
...
//             border: Border.all(
//               color: outlineColor.withOpacity(isactive ? 1 : 0.4),
//             ),
//           ),
//           child: Material(
...
//         ? (fontColor ?? kWhite)
//         : (fontColor ?? kWhite).withOpacity(0.7);
