...
class _LocationBottomSheetState extends State<LocationBottomSheet> {
  ...
  Widget build(BuildContext context) {
    // Phase 8 fix: previously this was an unconstrained Container used with
    // isScrollControlled: true, which let the sheet's content (a
    // shrink-wrapped ListView) expand to ~90% of the screen for any
    // reasonably long location list. DraggableScrollableSheet gives it an
    // explicit, user-resizable height band instead.
