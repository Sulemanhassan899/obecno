...
import 'package:Obecno/screens/Employee_module/more_module/account_setting.dart';
import 'package:Obecno/screens/Employee_module/more_module/change_password.dart';
import 'package:Obecno/screens/Employee_module/more_module/linked_devices.dart';
          ...
          children: [
            ...
            Center(
              child: CommonImageView(
                imagePath: Assets.imagesProfileImage, // use your asset
                height: 110,
                fit: BoxFit.contain,
              ),
            ),
            ...
            AppText.h5("Armando Predovic", weight: FontWeight.w600),

            const SizedBox(height: 6),

            AppText.p2("Director of Operations", color: kGreyColor),
            ...
            Container(
              ...
              child: Row(
                children: [
                  CommonImageView(
                    imagePath: Assets.imagesYellowTriangle,
                    height: 24,
                  ),
            ...
            _tile(
              ...
              onTap: () {
                Navigator.pushAndRemoveUntil(
                  context,
                  MaterialPageRoute(builder: (_) => const OfficeLocation()),
                  (route) => true,
                );
              },
            ),
